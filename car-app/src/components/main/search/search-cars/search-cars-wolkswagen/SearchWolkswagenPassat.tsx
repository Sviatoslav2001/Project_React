...
const SearchWolkswagenPassat = () => {
    ...
    return (
        ...
        <Link className='' to={'/searchwolkswagen'}><button className='search-cars-styles'>Повернутися назад</button></Link>
        </div>
    )
}
...
export default SearchWolkswagenPassat;